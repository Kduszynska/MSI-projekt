...
class RSP(BaseEnsemble, ClassifierMixin):
    """Random Sample Partition - zmodyfikowany - wybieranie podprzestrzeni ze względu na prawdopodobieństwo apriori"""
    def __init__(self, base_estimator=LinearSVC(), n_estimators=10, n_subspace_choose=0.3, n_subspace_features=20, hard_voting=True, random_state=None):
        #Klasyfikator bazowy
        ...
        #Procent wybranych podprzestrzeni [0,1]
